...
function getData() {
    ...
    var sessionData = sessionStorage.getItem('weather');
...
function reducer() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { cityToShow: 702550 };
    var action = arguments[1];

    switch (action.type) {
        case 'CHANGE_CITY':
            return { cityToShow: 702550 };
...
var SeedShop = function (_React$Component) {
    ...
    _createClass(SeedShop, [{
        ...
        value: function render() {
            var weatherInfoDetailed = store.getState().weatherData.list;
...
var DayInfo = function (_React$Component2) {
    _inherits(DayInfo, _React$Component2);
...
var Header = function (_React$Component3) {
    ...
    _createClass(Header, [{
        ...
        value: function render() {
            ...
            return React.createElement('div', { className: 'header' }, 'Displaying weather in ', cityName, ', ', countryCode);
        }
    }]);
...
},{"react":"react","react-dom":"react-dom","redux":18}],2:[function(require,module,exports){
